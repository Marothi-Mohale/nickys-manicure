...
public static class SeedDataExtensions
{
    ...
    [
        new() { Id = 1, Title = "Signature Red Crystal Set", Description = "A glossy red manicure with crystal placement for clients who want a bold, polished finish with clean salon structure.", Category = "Manicure", ImageUrl = "/images/salon/home/nicky-hero-manicure.jpg", ThumbnailUrl = "/images/salon/home/nicky-hero-manicure.jpg", AltText = "Bright red manicure with glossy square nails and crystal accents", IsFeatured = true, Status = ContentStatus.Published, DisplayOrder = 1 },
        new() { Id = 2, Title = "Pink Sculpted Detail", Description = "A statement manicure with soft pink structure, floral detailing, and elevated finish work for occasion-ready elegance.", Category = "Bridal", ImageUrl = "/images/salon/home/nicky-home-manicure-classic.jpg", ThumbnailUrl = "/images/salon/home/nicky-home-manicure-classic.jpg", AltText = "Pink sculpted manicure with floral art and glossy finish", IsFeatured = true, Status = ContentStatus.Published, DisplayOrder = 2 },
        new() { Id = 3, Title = "Soft Blush Pedicure", Description = "A clean, glossy pedicure in blush tones designed for understated luxury and sandal-ready presentation.", Category = "Pedicure", ImageUrl = "/images/salon/home/nicky-home-pedicure-luxury.jpg", ThumbnailUrl = "/images/salon/home/nicky-home-pedicure-luxury.jpg", AltText = "Soft pink pedicure with glossy polish and premium presentation", IsFeatured = false, Status = ContentStatus.Published, DisplayOrder = 3 },
        new() { Id = 4, Title = "Graphic Monochrome Gel", Description = "Modern gel artistry with crisp black-and-white illustration details for clients who want something creative and fashion-led.", Category = "Manicure", ImageUrl = "/images/salon/services/nicky-service-manicure-gel.jpg", ThumbnailUrl = "/images/salon/services/nicky-service-manicure-gel.jpg", AltText = "Black-and-white nail art on long square gel nails", IsFeatured = false, Status = ContentStatus.Published, DisplayOrder = 4 },
        new() { Id = 5, Title = "Luxury French Detail", Description = "Close-up finish work showing glossy pink structure and bright French detail with a more editorial salon mood.", Category = "Occasion", ImageUrl = "/images/salon/home/nicky-home-nail-detail.jpg", ThumbnailUrl = "/images/salon/home/nicky-home-nail-detail.jpg", AltText = "Neon pink French-tip nails with glossy salon detail", IsFeatured = true, Status = ContentStatus.Published, DisplayOrder = 5 }
    ];
